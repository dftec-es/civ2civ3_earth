...
artists = "
    ...
    FiftyNine (59)
    GriffonSpade (GS)
    Ngunjaca / NionG108 (Ng)
    VladimirSlavik (VS)
"

[file]
gfx = "amplio_earth/units"
...
;  1, 18, "u.sea_constructor_Idle"	; (VS)
  1, 19, "u.sailboat_Idle"			; [BB](Ng)
...
;  2, 16, "u.barbarian_leader_Idle"	; (59)
  2, 17, "u.migrants_Idle"		; Eleazar
;  2, 18, "u.drone_Idle"			; [Nemo][CS](GS)
;  2, 19, "u.train_Idle"			; Eleazar
  3,  5, "u.alpine_troops_Idle"		; [Nemo](GS)
  3, 11, "u.diplomat_Idle"		; (Ng)
  3, 13, "u.explorer_Idle"		; [Alex][CT](GS)
  3, 15, "u.leader_Idle"			; [GB](Ng)(GS)
  3, 16, "u.barbarian_leader_Idle"	; (59)(Ng)(GS)
  3, 17, "u.pikemen_Idle"		; [T](GS)
  3, 18, "u.warriors_Idle"		; [GB](Ng)(GS)
